            ...
            <>
                <header className="header-container">
                    ...
                    <div className="header-card">
                        <h1>Expand Your Reach, <span style={{ color: '#fdb10e' }}>Maximize</span> Your Earnings</h1>
                        <p>List your property and connect with a global student audience with Accomi.</p>
                ...
                <section style={{ padding: '5vh 0', margin: '0 6vw' }}>
                    <h1 style={{ fontWeight: 500, marginBottom: '20px' }}>Why Choose Us?</h1>
                    ...
                    <div className="wcu-container">
                        <div className="wcu-card">
                            ...
                            <p>From listing to booking, we handle the details so you can focus on what matters.</p>
                        </div>
                        ...
                        <div className="wcu-card">
                            ...
                            <p>Tap into a vast pool of international students looking for accommodation.</p>
                        </div>
                ...
                <section style={{ padding: '0 0 5vh 0', margin: '0 6vw' }}>
                    <h1 style={{ fontWeight: 500, marginBottom: '20px' }}>How It Works?</h1>
                    ...
                    <div className="hiw-container">
                        ...
                        <div className="hiw-tag">
                            ...
                            <div style={{ padding: '0.1rem 1.2rem' }}>
                                ...
                                <p>Students will discover your property through our Property Management System.</p>
                            </div>
                        </div>
                        ...
                        <div className="hiw-card">
                            ...
                            <div style={{ padding: '0.1rem 1.2rem' }}>
                                ...
                                <p>Easily handle bookings and communications through our Property Management System</p>
                            </div>
                        </div>
                    </div>
                </section>
